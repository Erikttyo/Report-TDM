...
public class PrintStrukActivity extends AppCompatActivity {
    ...
    private User user;
    private String timeStamp,norek,nama,nominal,title;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tinyDB = new TinyDB(PrintStrukActivity.this);
    ...
    private void printCustom(String msg, int size, int align) {
        ...
        byte[] bb = new byte[]{0x1B,0x21,0x06};  // 1- only bold text
