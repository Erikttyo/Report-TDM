                            ...
                            for (BluetoothDevice device : btDeviceList) {
                                if (btDeviceList.contains(device) == false) {
                                    ...
                                    mArrayAdapter.add(device.getName() + "\n"
                                            + device.getAddress());
                                    mArrayAdapter.notifyDataSetInvalidated();
                                    if (tinyDB.getObject("device",BluetoothDevice.class).getAddress().equals(device.getAddress())){
                                        pos = btDevices.getPosition(device);
                                        printStruk(pos);
                                    }
                                }
                            }
...
//    }
    ...
    public void printStruk(final int position){
        if (mBluetoothAdapter == null) {
            return;
        }
